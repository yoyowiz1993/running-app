...
| `AI_API_KEY` | Required (for programs) | Google Gemini API key from [Google AI Studio](https://aistudio.google.com/app/apikey). Programs are generated by AI based on user goal inputs. Free tier is sufficient for typical usage. |
